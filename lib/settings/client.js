  ...
  factory: (require) => {
    ...
    const MESSAGES = {
      ...
      en: {
        ...
        'sleep.heading': 'macOS sleep prevention',
    ...
    const styles = {
      ...
      checkbox: { width: '16px', height: '16px', marginLeft: '10px', accentColor: 'var(--dsw-alias-label-primary)', cursor: 'pointer' },
    ...
    function createSection(t) {
      ...
      return function Section() {
        ...
        return h('div', { style: styles.group }, [
          ...
          h('div', { key: 'separatorBeforePairing', style: styles.separator }),
          ...
          h('div', { key: 'separatorAfterUnbind', style: styles.separator }),

          h('div', { key: 'sleepTitle', style: styles.heading }, t('sleep.heading')),
          h(StatusRow, {
            key: 'sleepGuard',
            label: t('sleep.title'),
            action: h('input', {
          ...
          h('div', { key: 'separatorBeforeStatus', style: styles.separator }),
