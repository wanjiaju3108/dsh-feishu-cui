...
import { sendCardToBoundUser } from './init.js';
...
import { ANNOUNCE_NO_SESSION_TEXT, ANNOUNCE_SESSION_TEXT, UNBOUND_TEXT, UNBOUND_TITLE } from './copy.js';
...
export async function apply(ctx) {
  ...
  async function announceConnected() {
    ...
    try {
      await sendCardToBoundUser({ logger, push, card: buildTextCard(text) });
    } catch (error) {
