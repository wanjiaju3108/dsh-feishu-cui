...
/** 回答卡片：卡片没能发到飞书（不管什么原因）时的标题。 */
export const ANSWER_SEND_FAILED_TITLE = '发送失败';

/** 卡片没能发到飞书时写在上面的这句，让人去网页端看，或者重问一次。 */
export const ANSWER_SEND_FAILED_TEXT = '这条回答没能发到飞书，请到网页端查看这一轮，或者重新问一次';
